...
export default function Footer() {
  ...
  if (activeTemplate === 'minimal') {
    return (
      <footer className="py-32 px-12 transition-colors duration-500" style={{ backgroundColor: 'var(--color-footer-bg)', color: 'var(--color-footer-text)' }}>
  ...
  if (activeTemplate === 'apple') {
    return (
      <footer className="font-sans text-xs pt-12 pb-8 border-t border-[#d2d2d7] transition-colors duration-500" style={{ backgroundColor: 'var(--color-footer-bg)', color: 'var(--color-footer-text)' }}>
  ...
  if (activeTemplate === 'obsidian') {
    return (
      <footer className="py-40 font-sans border-t border-white/5 transition-colors duration-500" style={{ backgroundColor: 'var(--color-footer-bg)', color: 'var(--color-footer-text)' }}>
  ...
  // DEFAULT FOOTER
  return (
    <footer className="py-40 font-sans transition-colors duration-500" style={{ backgroundColor: 'var(--color-footer-bg)', color: 'var(--color-footer-text)' }}>
