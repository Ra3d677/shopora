          ...
          <>
            ...
            >
              ...
              <div className="px-3 py-2 border-b border-white/5 mb-2">
                <span className="text-[10px] font-black uppercase tracking-widest text-slate-500">{t('addNewElement')}</span>
              </div>
              ...
              {currentButtons.length > 0 && (
                <div className="mt-4 pt-4 border-t border-white/5">
                  <div className="px-3 py-2 mb-2 flex items-center justify-between">
                    <span className="text-[10px] font-black uppercase tracking-widest text-slate-500">{t('manageButtons')}</span>
              ...
              <div className="mt-4 pt-4 border-t border-white/5 opacity-40">
                <div className="px-3 py-2 mb-1 flex items-center gap-2">
                  ...
                  <span className="text-[10px] font-bold text-slate-500 uppercase">{t('imageBlocksComing')}</span>
                </div>
                <div className="px-3 py-2 flex items-center gap-2">
                  <Type size={12} className="text-slate-500" />
                  <span className="text-[10px] font-bold text-slate-500 uppercase">{t('textBlocksComing')}</span>
                </div>
              </div>
            </motion.div>
          </>
