...
function CreateStoreForm() {
  ...
  const websiteTemplates = [
    ...
    { id: 'hotel1', name: 'Luxe Hotel', desc: 'قالب فندق فاخر متكامل - 11 صفحة مع حجز، أجنحة، مطعم، سبا، معرض، وكل شيء.', img: 'https://s.tmimgcdn.com/scr/800x500/400600/luxe-premium-luxury-hotel-booking-bootstrap-html-website-template_400677-original.png' },
  ];
