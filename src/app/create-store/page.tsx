...
function CreateStoreForm() {
  ...
  const websiteTemplates = [
    ...
    { id: 'hotel2', name: 'Hotel 2 - Luxe', desc: 'Luxury hotel booking template with 16 pages - hero carousel, rooms, suites, restaurant, spa, gallery, blog and more.', img: 'https://images.unsplash.com/photo-1566073771259-6a8506099945?w=400&q=80' },
  ];
