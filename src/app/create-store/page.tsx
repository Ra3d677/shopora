...
function CreateStoreForm() {
  ...
  const websiteTemplates = [
    ...
    { id: 'mo', name: 'MO - IT Agency', desc: 'قالب متكامل لشركات التكنولوجيا وحلول الأعمال - نفس تصميم 11G.', img: 'https://images.unsplash.com/photo-1559136555-9303baea8ebd?w=400&q=80' }
  ];
