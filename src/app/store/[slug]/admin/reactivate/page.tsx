...
const CYCLES = [
  { id: "monthly", label: "شهري", labelEn: "Monthly", price: 9, totalPrice: 9, total: "$9", billing: "تدفع شهرياً", billingEn: "billed monthly", savings: null, color: "blue", popular: false },
  { id: "3-months", label: "3 شهور", labelEn: "3 Months", price: 7, totalPrice: 21, total: "$21", billing: "تدفع كل 3 شهور", billingEn: "billed every 3 months", savings: "وفر $6", color: "emerald", popular: false },
  { id: "6-months", label: "6 شهور", labelEn: "6 Months", price: 5.5, totalPrice: 33, total: "$33", billing: "تدفع كل 6 شهور", billingEn: "billed every 6 months", savings: "وفر $21", color: "cyan", popular: true },
  { id: "annual", label: "سنوي", labelEn: "Annual", price: 4.5, totalPrice: 54, total: "$54", billing: "تدفع سنوياً", billingEn: "billed annually", savings: "وفر $54", color: "purple", popular: false },
];
      ...
      <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-6">
        <div className="max-w-lg w-full space-y-8">
          <div className="text-center space-y-4">
            ...
            <p className="text-slate-400 text-sm">{cycle.label} — {cycle.total} ≈ {totalEGP(cycle.totalPrice).toLocaleString()} ج.م</p>
          </div>
          ...
          <div className="bg-amber-500/5 border border-amber-500/20 rounded-2xl p-6 space-y-3">
            ...
            <ol className="text-slate-400 text-xs space-y-2 leading-relaxed">
              ...
              <li>2. حول المبلغ <span className="text-white font-black">{cycle.total} ≈ {totalEGP(cycle.totalPrice).toLocaleString()} ج.م</span> على الرقم: <span className="text-white font-black text-sm">{VODAFONE_CASH_NUMBER}</span></li>
    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-6">
      <div className="max-w-4xl w-full space-y-8">
          ...
          {CYCLES.map((c) => (
            ...
            >
              ...
              <p className="text-[10px] text-yellow-400 font-black mt-1">
                ≈ {totalEGP(c.totalPrice).toLocaleString()} ج.م
              </p>
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          >
            <Phone className="w-5 h-5" /> دفع عبر فودافون كاش — {cycle.total} ≈ {totalEGP(cycle.totalPrice).toLocaleString()} ج.م
          </button>
