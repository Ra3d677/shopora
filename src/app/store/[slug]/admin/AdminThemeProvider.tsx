...
export function AdminThemeProvider({
  ...
  const darkVars = {
    "--admin-bg": "#0a0c14",
    "--admin-sidebar-bg": "rgba(15,17,26,0.8)",
    "--admin-card-bg": "rgba(26,29,45,0.8)",
    "--admin-card-bg-solid": "#1a1d2d",
    "--admin-header-bg": "rgba(10,12,20,0.5)",
    ...
    "--admin-glow-pink": "rgba(236,72,153,0.2)",
    "--admin-nav-active-bg": "rgba(6,182,212,0.1)",
    "--admin-nav-hover-bg": "rgba(255,255,255,0.02)",
    "--admin-section-header": "rgba(26,29,45,1)",
