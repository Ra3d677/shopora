...
export default async function AdminLayout({
  ...
  const mainItems = isWebsite ? [
    ...
    ...(store.template === 'ironpeak' ? [{ label: isRTL ? 'لوحة تحكم آيرون بيك' : 'IronPeak Dashboard', iconName: 'LayoutDashboard' as const, path: '/ironpeak', color: 'text-orange-500' }] : []),
    ...
    { label: isRTL ? 'من نحن' : 'About Us', iconName: 'Info', path: '/about-us', color: 'text-blue-500' },
  ] : [
    { label: t('overview'), iconName: 'LayoutDashboard', path: '/dashboard', color: 'text-cyan-500' },
