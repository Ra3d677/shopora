...
const DEFAULT_BANNERS = [
  {
    desktopImage: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=1920&q=80",
    mobileImage: "",
  ...
  {
    desktopImage: "https://images.unsplash.com/photo-1571902943202-507ec2618e8f?w=1920&q=80",
    mobileImage: "",
    title: "PUSH BEYOND YOUR LIMITS",
    subtitle: "No Pain, No Gain",
    description: "Discover your true potential with our expert trainers and state-of-the-art equipment.",
    ctaText: "Join Today",
    ctaLink: "#join",
  },
  {
    desktopImage: "https://images.unsplash.com/photo-1518611012118-696072aa579a?w=1920&q=80",
    mobileImage: "",
    title: "TRAIN HARD, STAY STRONG",
    subtitle: "Fitness is Not About Being Better Than Others",
    description: "It's about being better than you used to be. Start your fitness journey with us.",
    ctaText: "Get Started",
    ctaLink: "#pricing",
  },
];
...
export default function TwoHBannersManager({ slug, initialSettings }: { slug: string; initialSettings: any }) {
    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-slate-400 mt-1">Manage hero slider banners for your 2H template</p>
        </div>
            ...
            <div className="p-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="relative bg-black rounded-xl overflow-hidden" style={{ aspectRatio: `${DESKTOP_RATIO}` }}>
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/30 to-transparent flex flex-col justify-center px-8">
                    <div className="max-w-[70%]">
                      ...
                      {slide.description && (
                        <p className="text-white/50 text-[10px] leading-relaxed line-clamp-1 mt-1">{slide.description}</p>
                      )}
                      {slide.ctaText && (
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea rows={2} value={slide.description}
