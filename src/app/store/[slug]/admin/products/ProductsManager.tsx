                ...
                <div className="p-8 bg-white/[0.02] border border-white/[0.03] rounded-3xl">
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                    {formData.colors?.map((colorObj: any, index: number) => {
                      ...
                      return (
                        <div key={index} className="group/color bg-white/[0.03] border border-white/[0.05] hover:border-white/10 rounded-2xl p-4 transition-all duration-300">
                          <div className="flex items-center gap-4">
                            {/* Color & Info */}
                            ...
                            {/* Media Node */}
                            <div className="relative w-16 h-16 rounded-xl bg-black/40 border border-white/5 overflow-hidden group/media shrink-0">
                               {color.imageUrl ? (
                                 <>
                            ...
                            <div className="flex-1 space-y-3">
                               <div className="flex items-center justify-between">
                                  <label className="text-[9px] font-black text-slate-500 uppercase tracking-widest">Visual Link</label>
                                  <button type="button" onClick={() => handleRemoveColor(index)} className="text-slate-600 hover:text-rose-500 transition-colors">
                               ...
                               <div className="flex items-center gap-3">
                                  ...
                                  <div className="flex-1 flex items-center bg-white/5 border border-white/5 rounded-lg overflow-hidden focus-within:border-cyan-500/30">
                                     <button 
                                       type="button" 
                                       onClick={() => handleUpdateColorField(index, 'stock', Math.max(0, (color.stock || 0) - 1))}
                                       className="w-8 h-8 flex items-center justify-center text-slate-500 hover:text-white hover:bg-white/5 transition-all text-xs font-bold"
                                     >-</button>
                                     <input 
                                       type="number"
                                       value={color.stock || 0}
