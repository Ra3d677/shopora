...
export default async function AdminDashboard({ params, searchParams }: { params: Promise<{ slug: string }>, searchParams: Promise<{ range?: string }> }) {
  ...
  return (
    <div dir={isRTL ? "rtl" : "ltr"}             className={`min-h-screen p-8 pb-24 font-sans selection:bg-cyan-500/30 admin-bg admin-text ${isRTL ? 'text-right' : 'text-left'}`}>
      {/* Header Section */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
         ...
         <div className="admin-card p-8 rounded-[2rem] border admin-border relative overflow-hidden group hover:border-cyan-500/50 transition-all duration-500">
            ...
            <h4 className={`text-[10px] font-black uppercase tracking-[0.2em] admin-text-muted mb-6 flex items-center gap-2 ${isRTL ? 'justify-start' : ''}`}>
         ...
         {/* Orders / Visits Card */}
         <div className="admin-card p-8 rounded-[2rem] border admin-border relative overflow-hidden group hover:border-pink-500/50 transition-all duration-500">
         ...
         <div className="admin-card p-8 rounded-[2rem] border admin-border relative overflow-hidden group hover:border-amber-500/50 transition-all duration-500">
             ...
             {/* Sales / Leads Funnel */}
              <div className="admin-card p-6 rounded-2xl border admin-border shadow-2xl">
               ...
               <div className="space-y-6">
                  ...
                  <div className="admin-subcard p-6 rounded-3xl border admin-border flex items-center justify-between group hover:border-purple-500/30 transition-all">
                  ...
                  <div className="admin-subcard p-6 rounded-3xl border admin-border flex items-center justify-between group hover:border-amber-500/30 transition-all">
                     <div className="flex items-center gap-4">
                  ...
                  <div className="admin-subcard p-6 rounded-3xl border admin-border flex items-center justify-between group hover:border-green-500/30 transition-all">
                     <div className="flex items-center gap-4">
                  ...
                  {topProducts.map((p, idx) => (
                     <div key={p.id} className="flex items-center justify-between group">
                        <div className="flex items-center gap-6">
                           ...
                           <div className="w-16 h-16 admin-subcard rounded-2xl overflow-hidden border admin-border group-hover:border-cyan-500/30 transition-all shadow-xl">
               ...
               <div className="min-w-[700px]">
                  <div className="flex mb-4">
                     ...
                     {Array(24).fill(0).map((_, i) => (
                        <div key={i} className="flex-1 text-center text-[9px] font-black admin-text-muted">{i}h</div>
                     ))}
                  </div>
