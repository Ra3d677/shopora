  ...
  return (
    <div className="min-h-screen py-24 px-6">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-5xl font-black tracking-tighter uppercase mb-4">Blog</h1>
        <p className="text-slate-500 font-medium mb-16 max-w-xl">Stories, insights, and updates from {store.name}.</p>

        {posts.length === 0 ? (
          <div className="border border-dashed border-slate-200 rounded-[2rem] p-20 text-center">
            <p className="text-slate-400 font-bold uppercase tracking-widest text-xs">No posts yet.</p>
          </div>
        ) : (
                ...
                <article className="bg-white rounded-[2rem] overflow-hidden border border-slate-100 shadow-xl hover:shadow-2xl transition-all group-hover:-translate-y-1">
                  ...
                  <div className="p-8">
                    ...
                    <div className="flex items-center gap-4 text-[10px] font-black uppercase tracking-widest text-slate-400">
                      ...
                      <span className="ml-auto flex items-center gap-1 text-slate-900 group-hover:gap-2 transition-all">Read <ArrowRight size={14} /></span>
                    </div>
                  </div>
                </article>
              </Link>
